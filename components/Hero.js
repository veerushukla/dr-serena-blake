  ...
  return (
    <div id="Hero" className="min-h-screen  bg-blue-300 relative py-12">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col text-center justify-center items-center">
        ...
        <h2 className="mt-4 text-white text-xl sm:text-2xl font-light max-w-2xl drop-shadow-md">
        ...
        <div className="count text-white mt-8 text-2xl sm:text-4xl font-bold max-w-2xl drop-shadow-md flex flex-row justify-between gap-8">
